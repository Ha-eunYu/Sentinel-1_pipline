...
- [ ] **(신규 최우선) 북한 동일궤도 pre/post 쌍 비교** — 여러 궤도 섞은
      baseline이 아니라 같은 relative orbit 진짜 pre/post 1:1 차분으로 재분석.
      가능 쌍: 7/13↔7/1, 7/18↔7/6, 7/19↔6/25. P1.5의 7/1↔7/13 dB차분+HAND
      접근을 확장. 상세는 [FLOOD_NORTH_KOREA_KR.md](FLOOD_NORTH_KOREA_KR.md) 4-1절.
