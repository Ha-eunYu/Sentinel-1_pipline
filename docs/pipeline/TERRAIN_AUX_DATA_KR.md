...
출처·다운로드·사용법 정리. 관련 스크립트: [download_hand.py](../../s1/tools/download/download_hand.py),
[prepro_grd_gpt.py](../../s1/preprocess/prepro_grd_gpt.py), [prepare_ngii_dem.py](../../s1/tools/dem/prepare_ngii_dem.py)
...
- **스크립트**: [download_hand.py](../../s1/tools/download/download_hand.py) — 홍수 AOI(+0.1°)를 덮는 타일을
...
- 이미 WGS84 경위도라서 [prepare_ngii_dem.py](../../s1/tools/dem/prepare_ngii_dem.py)의 재투영 단계는
...
[prepro_grd_gpt.py](../../s1/preprocess/prepro_grd_gpt.py)는 `--dem <경로>` 옵션으로 External DEM 처리를
