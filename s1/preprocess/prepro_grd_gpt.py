...
from s1.core.paths import PROJECT_DIR  # 경로는 s1.core.paths에서만 정의
...
from s1.preprocess.prepro_gpt import aoi_wkt_from_geojson  # noqa: E402
...
def main() -> None:
    ...
    graph_xml = PROJECT_DIR / "graphs" / graph_xml_name
