...
from s1.footprint import bbox_to_polygon, load_boundary_union  # noqa: E402
from s1.tools.water.water_area_report import _polygon_area_m2
...
def main() -> None:
    ...
    ap.add_argument("--out-dir", type=Path, default=PROJECT_DIR / "qa")
    args = ap.parse_args()
